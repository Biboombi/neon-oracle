  ...
  return c.html(`
    ...
    <head>
      ...
      <style>
        ...
        .btn-twitter { margin-top: 20px; text-decoration: none; color: var(--neon-pink); border: 1px solid var(--neon-pink); padding: 12px 30px; font-size: 1rem; text-transform: uppercase; font-weight: bold; transition: 0.3s; display: inline-block; box-shadow: 0 0 5px var(--neon-pink); width: 100%; max-width: 300px; box-sizing: border-box; }
    ...
    <body>
      ...
      <div class="container">
        ...
        <a href="https://twitter.com/biboombii" target="_blank" class="btn-twitter">Follow Twitter</a>
      </div>
      <script>
